...
<p>Kirill Ushakov built the Brain Assistant app as a free app. This SERVICE is provided by Kirill Ushakov at no cost and is intended for use as is. </p>
...
<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
    which is accessible at Brain Assistant, unless otherwise defined in this Privacy Policy.</p>

<p><strong>Information Collection and Use</strong></p>
<p>For a better experience while using our Service, I may require you to provide us with certain
    personally identifiable information, including but not limited to users name, email, location, user input messages.
	The information that I request will be retained by me and used as described in this privacy policy.</p>
<p>The app does use third party (Google) services that may collect information used to identify you.
    You can read Google Privacy Policy here: <a href="https://www.google.com/intl/en/policies/privacy/"></a></p>
...
<p>I want to inform you that whenever you use [my|our] Service, in case of an error in the app I collect
    ...
    operating system version, configuration of the app when utilising my ervice, the time and date
