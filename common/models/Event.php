...
class Event extends ActiveRecord {
    ...
    public function afterSave($insert, $changedAttributes) {
        ...
        Yii::warning("=======task->id=======" . $task->id);
        Yii::warning("=====status=========" . $task->status);
        Yii::warning("=====count(changedAttributes)=========" . count($changedAttributes));
        Yii::warning("=====_SESSION['tasksFromdDevice'][task->id]========" . $_SESSION['tasksFromdDevice'][$task->id]);
